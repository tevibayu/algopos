<?php namespace Modules\Transaction\Providers;
...
class TransactionServiceProvider extends ServiceProvider {
	...
	{
		$viewPath = base_path('resources/views/modules/transaction');
	...
	{
		$langPath = base_path('resources/lang/modules/transaction');
