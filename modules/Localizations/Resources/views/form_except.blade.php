...
@section ('breadcrumbs')
    ...
    <li>{!! link_to_route('admin.localizations.except', trans('localizations::except.menus.index')) !!}</li>
...
<div class="box box-warning">
    <div class="panel-body">
        @if($form_type == 'create')
        {!! Form::open(['route' => 'admin.localizations.create_except', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create']) !!}
        @elseif($form_type == 'edit')
        {!! Form::model($record, ['route' => ['admin.localizations.edit_except', $record->id_localization], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'edit']) !!}
        @endif
...
<script>
    ...
    var url_get_records = "{{ url('admin/localizations/except/get_records') }}";
    var except_records = {!! $form_type == 'edit' ? '['.$except_records.']' : "''" !!};
</script>

{!! HTML::script(Module::asset('Localizations:Assets/js/form_except.js')) !!}
