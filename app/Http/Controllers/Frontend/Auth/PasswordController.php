...
class PasswordController extends Controller {
	...
	public function postChangePassword(ChangePasswordRequest $request) {
        ...
        $activities->log_activity($request,'Change Password','Settings');
		return redirect()->route('backend.password.change')->withFlashSuccess(trans("strings.password_successfully_changed"));
	}
}
