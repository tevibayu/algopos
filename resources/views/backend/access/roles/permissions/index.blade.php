                ...
                <div role="tabpanel" class="tab-pane active" id="permissions">
                    ...
                    <div class="box-header with-border">
                        <div class="col-sm-3" style="padding: 5px 0px 5px 0px;">
                            {!! Form::open(['route' => 'admin.access.roles.permissions.index', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'get', 'id' => 'search']) !!}
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            @if ($permissions->count())
                                ...
                                @endforeach
                            @else
                                <td colspan="9">{{ trans('strings.no_record') }}</td>
                            @endif
                        </tbody>
                    </table>
...
@if ($permissions->count())
    <script>
        var record_numb = {{ (($permissions->currentPage()-1) * config('access.users.default_per_page')) + 1 }};
    </script>

    {!! HTML::script('public/js/backend/access/permissions/datatable.js') !!}
@endif
