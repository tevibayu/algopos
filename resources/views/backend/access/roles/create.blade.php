...
@section('after-styles-end')
    {!! HTML::style('public/css/backend/plugin/jstree/themes/default/style.min.css') !!}
@stop
...
<div class="box box-warning">
    ...
    {!! Form::open(['route' => 'admin.access.roles.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-role']) !!}
        ...
        <div class="form-group">
            {!! Form::label('login_destination', trans('validation.attributes.login_destination'), ['class' => 'col-lg-2 control-label']) !!}
            <div class="col-lg-10">
                {!! Form::text('login_destination', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.login_destination')]) !!}
            </div>
        </div>
...
@section('after-scripts-end')
    {!! HTML::script('public/js/backend/plugin/jstree/jstree.min.js') !!}
    {!! HTML::script('public/js/backend/access/roles/script.js') !!}
@stop