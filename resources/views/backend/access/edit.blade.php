                            ...
                            <div class="col-lg-3">
                                <ul style="margin:0;padding:0;list-style:none;">
                                    @foreach ($perm as $p)
                                        ...
                                        <li><input type="checkbox" value="{{$p['id']}}" name="permission_user[]" data-dependencies="{!! $dependencies !!}" {{in_array($p['id'], $user_permissions) ? 'checked' : ""}} id="permission-{{$p['id']}}" /> <label style="font-size: 10px;" for="permission-{{$p['id']}}">
...
@section('after-scripts-end')
    {!! HTML::script('public/js/backend/access/permissions/script.js') !!}
    {!! HTML::script('public/js/backend/access/users/script.js') !!}
@stop